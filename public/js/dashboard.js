document.addEventListener("DOMContentLoaded", function () {
  ...
  async function applyFilters() {
    ...
    const specialization = specializationSelect.options[specializationSelect.selectedIndex].text;
  ...
  document.getElementById("resetFilters").addEventListener("click", () => {
    document.getElementById("languageFilter").selectedIndex = 0;
    document.getElementById("specializationFilter").selectedIndex = 0;
